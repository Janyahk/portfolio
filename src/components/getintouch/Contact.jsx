  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://portfolio-qwi1.onrender.com/send-mail",
        {
          method: "POST",
          headers: {
    ...
    <div className="my-16 px-6 md:px-20">
      ...
      <div className="flex justify-center items-center gap-3 mb-10">
        <h1
          className="
            ...
            md:text-6xl
            font-bold
            bg-[url('assets/nav_underline.svg')]
            bg-no-repeat
            bg-right-bottom
            bg-[length:100px]
          "
      ...
      <div className="flex flex-col md:flex-row gap-10">
        ...
        <div className="w-full md:w-1/2 p-2">
          ...
          <p className="mb-6 text-base md:text-lg leading-relaxed">
            I’m currently looking for exciting job or internship
            opportunities where I can learn, contribute, and grow as a
            developer. If you think I could be a good fit for your team,
            feel free to reach out — I’d love to connect!
          </p>
